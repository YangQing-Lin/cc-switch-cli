...
var messages = map[string]map[string]string{
	"en": {
		...
		"error.model_required":            "Default model is required",
		"error.reasoning_required":        "Reasoning effort is required",
	...
	"zh": {
		...
		"error.model_required":            "默认模型不能为空",
		"error.reasoning_required":        "推理强度不能为空",
